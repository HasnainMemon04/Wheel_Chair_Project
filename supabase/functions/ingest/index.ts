    ...
    if (payload.kind === 'telemetry') {
      ...
      const { error: stateError } = await supabase
        ...
        .upsert({
          ...
          sats: payload.sats,
          hdop: payload.hdop,
          gps_fix: payload.gps_fix === 1,
          gps_simulated: payload.gps_simulated === 1,
          gps_course: payload.gps_course,
          gps_altitude: payload.gps_altitude,
          gps_age_ms: payload.gps_age_ms,
          gps_chars: payload.gps_chars,
          gps_sentences: payload.gps_sentences,
          gps_checksum_failures: payload.gps_checksum_failures,
          gps_nmea_gga: payload.gps_nmea_gga || null,
          gps_nmea_rmc: payload.gps_nmea_rmc || null,
          pitch: payload.pitch,
          roll: payload.roll,
          tilt: payload.tilt,
          yaw: payload.yaw,
          imu_accel_x: payload.imu_accel_x,
          imu_accel_y: payload.imu_accel_y,
          imu_accel_z: payload.imu_accel_z,
          imu_gyro_x: payload.imu_gyro_x,
          imu_gyro_y: payload.imu_gyro_y,
          imu_gyro_z: payload.imu_gyro_z,
          imu_age_ms: payload.imu_age_ms,
